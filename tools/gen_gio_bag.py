...
def read_imu_csv(dir_path):
        acc_path = dir_path + "/data/raw_data/2/accel-0.csv"
        gyro_path = dir_path + "/data/raw_data/2/gyro-0.csv"
        imu_time = dir_path + "/data/raw_data/2/time.csv"
...
def read_gps_csv(dir_path):
    gps_file_path = dir_path + "/data/raw_data/2/gps-0.csv"
    gps_time_file_path = dir_path + "/data/raw_data/2/gps_time.csv"
...
def make_bag(dir_path):
        bag_path = dir_path + "/data/test_2.bag"
